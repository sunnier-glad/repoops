    ...
    <main class="main-content">
      ...
      <section class="workspace-banner">
        <div>
          ...
          <h2>{{ session ? `${session.github_login} 的项目空间` : '连接 GitHub，开始管理项目质量' }}</h2>
      ...
      <section class="lower-grid">
        <article class="panel activity-panel">
          ...
          <div class="empty-state"><div class="empty-icon">⌁</div><strong>还没有 GitHub 事件</strong><p>绑定第一个仓库后，push、PR、CI 和 release 会自动出现在这里。</p><a href="/api/auth/github">连接 GitHub <span>↗</span></a></div>
        </article>
